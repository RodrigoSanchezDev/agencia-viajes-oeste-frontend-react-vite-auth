...
export const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // Con Magic Link, el registro es igual que el login: enviar código al email
      await authService.register({ email });
      // Navegamos a la página de verificación con el email
        ...
        <div className="register-form-wrapper">
          ...
          <div className="register-form__credentials-box">
            ...
            <div className="register-form__credentials-content">
              <p className="register-form__credentials-title">Magic Link</p>
              <p className="register-form__credentials-text">Recibirás un código de verificación en tu email</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="register-form" noValidate>
            ...
            <div className="register-form__info">
              <HiOutlineMail className="register-form__info-icon" />
              <p>Te enviaremos un código de 6 dígitos para verificar tu cuenta</p>
            </div>
